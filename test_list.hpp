#ifndef LAB2_2_TEST_LIST_HPP
#define LAB2_2_TEST_LIST_HPP

#include "list_sequnce.hpp"

template<typename T>
class set_test {
private:
    list_sequence<T> first;
    list_sequence<T> second;
public:
...
void get_index_arr_test<T>::test() {
    ...
    list_sequence<T> answer(first.get_index_data(1, 2));
    if (answer == &second) {
        std::cout << "Test pass";
    } else {
        std::cout << "Test faild";
